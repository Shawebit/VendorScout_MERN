      ...
      <div className="vendor-dashboard-container">
        ...
        <div className="vendor-dashboard-card">
          ...
          <div style={{ marginBottom: '1rem' }}>
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', marginTop: '0.5rem' }}>
              <span className={message.length > 250 ? 'character-count-warning' : ''} style={{ fontSize: '0.875rem' }}>
                {message.length}/280 characters
              </span>
              <span style={{ fontSize: '0.875rem', color: 'var(--color-medium-grey)' }}>
                {followers} followers
              </span>
            </div>
          </div>
        ...
        <div className="vendor-dashboard-card">
          ...
          {messages.length === 0 ? (
            ...
            <div>
              {messages.map((msg) => (
                <div key={msg._id} className="broadcast-message-item">
                  <div className="broadcast-message-content">
                    <p>{msg.content}</p>
                  </div>
                  <div className="broadcast-message-meta">
                    <span className="broadcast-message-timestamp">{formatTimestamp(msg.createdAt)}</span>
