...
const FollowedVendorsDetail = () => {
  ...
  return (
    <div className="customer-dashboard">
      ...
      <div className="customer-dashboard-container">
        {/* Back to Followed Vendors Button */}
        <div style={{ marginBottom: '1rem' }}>
          <button
            onClick={() => navigate('/customer/followed')}
            className="btn-smooth secondary"
          >
            ← Back to Followed Vendors
          </button>
        </div>
                    ...
                    <div key={item._id} className="menu-item-card-horizontal">
                      ...
                      <div className="menu-item-content-horizontal">
                        ...
                        <div className="menu-item-details-horizontal">
                          ...
                          <div className="menu-item-price-horizontal">{formatPrice(item.price)}</div>
                        </div>
                      </div>
                    </div>
                  ))}
